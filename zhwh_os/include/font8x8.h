/**
 * @file font8x8.h
 * @brief Minimal 8x8 bitmap font (printable ASCII 32-126)
 *
 * Each glyph is 8 bytes (1 byte per row, MSB = leftmost pixel).
 * 95 glyphs × 8 bytes = 760 bytes total.
 */

#ifndef FONT8X8_H
#define FONT8X8_H

// Index into the array: font8x8_data[char - 32][8]
// char 32 (space) is at index 0
static const unsigned char font8x8_data[95][8] = {
    // 32 ' '
    ...
    // 37 '%'
    {0x66,0xAC,0xD8,0x30,0x6E,0xD6,0x66,0x00},
    // 38 '&'
    ...
    // 126 '~'
    {0x72,0xDC,0x00,0x00,0x00,0x00,0x00,0x00},
};
